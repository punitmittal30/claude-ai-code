...
class CleanQuizCache extends Action implements HttpGetActionInterface
{
    /**
     * @var Redirect
     */
    ...
    {
        try {
            $this->configRedisCache->deleteQuizCache();
            $this->messageManager->addSuccessMessage(__('Quiz cache has been cleaned.'));

...
class CleanVideoCache extends Action implements HttpGetActionInterface
{
    /**
     * @var Redirect
     */
    ...
    {
        try {
            $this->configRedisCache->deleteVideoCache();
            $this->messageManager->addSuccessMessage(__('Video cache has been cleaned.'));
    ...
    {
        return $this->_authorization->isAllowed('Pratech_VideoContent::videos');
    }
}

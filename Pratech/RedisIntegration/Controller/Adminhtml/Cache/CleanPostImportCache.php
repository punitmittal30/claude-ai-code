...
class CleanPostImportCache extends Action implements HttpGetActionInterface
{
    /**
     * @var Redirect
     */
    ...
    public function execute(): Redirect
    {
        try {
            ...
            $this->_eventManager->dispatch('clean_post_import_cache_after');
            $this->messageManager->addSuccessMessage(__('Post Import cache has been cleaned.'));
    ...
    {
        return $this->_authorization->isAllowed('Magento_Backend::flush_post_import');
    }
}

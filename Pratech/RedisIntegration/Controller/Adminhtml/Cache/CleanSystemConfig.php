...
class CleanSystemConfig extends Action implements HttpGetActionInterface
{
    /**
     * @var Redirect
     */
    ...
    public function __construct(
        ...
        protected SystemConfigurationRedisCache $systemConfigurationRedisCache
    ) {
    ...
    {
        try {
            $this->systemConfigurationRedisCache->deleteSystemConfigCache();
            $this->messageManager->addSuccessMessage(__('System config cache has been cleaned.'));

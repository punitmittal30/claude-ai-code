...
class Permissions implements ArgumentInterface
{
    ...
    {
        return $this->authorization->isAllowed('Pratech_VideoContent::videos');
    }

    /**
     * Has Access To Flush OTP Bypass List Cache
     *
     * @return bool
     */
    public function hasAccessToFlushOtpBypassListCache(): bool
    {
        return $this->authorization->isAllowed('Magento_Backend::flush_system_config');
    }
}

...
class SystemConfigurationRedisCache
{
    ...
    /**
     * OTP Bypass Prefix Constant
     */
    public const OTP_BYPASS_PREFIX = "list:bypass:numbers";
    ...
    /**
     * Delete OTP Bypass List Cache
     *
     * @return void
     */
    public function deleteOtpBypassListCache(): void
    {
        if (!$this->redisConnection) {
            return;
        }
        $keys = $this->getKeys(self::OTP_BYPASS_PREFIX);
        if (count($keys)) {

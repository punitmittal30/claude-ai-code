...
class Save extends Action
{
    ...
    public function execute()
    {
        ...
        if (isset($data['video_products'])) {
            $data['posted_video_products'] = $this->getVideoProducts($data['video_products']);
            unset($data['video_products']);
        }
     ...
     *
     * @param string $videoProducts
     * @return array
     */
    protected function getVideoProducts(string $videoProducts): array
    {
        $productIds = [];
        if (empty($videoProducts)) {
            return $productIds;
        }

        return $this->json->unserialize($videoProducts);
    }

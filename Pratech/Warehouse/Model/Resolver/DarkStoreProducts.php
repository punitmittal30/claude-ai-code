...
/**
 * GraphQL resolver for dark store products by pincode
 */
class DarkStoreProducts implements ResolverInterface
{
    /**
    ...
    public function resolve(
        ...
        try {
            $result = $this->warehouseProductRepository->getProductsByPincode(
                $pincode,
                (int)$pageSize,
                (int)$currentPage,
                $sortField,
            ...
            $this->logger->error('GraphQL dark store products error: ' . $e->getMessage());
            throw new GraphQlNoSuchEntityException(__($e->getMessage()));
        } catch (\Exception $e) {
            $this->logger->error('Unexpected error in dark store products resolver: ' . $e->getMessage());

...
class Edit extends \Pratech\Blog\Controller\Adminhtml\Category
{
    /**
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('pratech_blog_category', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(
            $model->getId() ? __('Edit %1', $model->getName()) : __('New Category')
        );
        return $resultPage;
    }
}

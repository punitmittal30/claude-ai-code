...
class Edit extends \Pratech\Blog\Controller\Adminhtml\Comment
{
    /**
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('pratech_blog_comment', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(
            $model->getId() ? __('Edit Comment %1', $model->getId()) : __('New Comment')
        );
        return $resultPage;
    }
}

...
class Edit extends \Pratech\Blog\Controller\Adminhtml\Tag
{
    /**
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('pratech_blog_tag', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend(
            $model->getId() ? __('Edit Tag %1', $model->getId()) : __('New Tag')
        );
        return $resultPage;
    }
}

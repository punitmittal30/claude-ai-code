...
{
    public const URL_PATH_DETAILS = 'pratech_blog/tag/details';
    public const URL_PATH_EDIT = 'pratech_blog/tag/edit';
    public const URL_PATH_DELETE = 'pratech_blog/tag/delete';

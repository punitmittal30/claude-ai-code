...
namespace Pratech\Banners\Block\Adminhtml\Banner\Tab;
...
class ProductGrid extends Extended
{
    ...
    {
        return $this->getUrl('*/banner/grids', ['_current' => true]);
    }
    ...
    {
        parent::_construct();
        $this->setId('banner_grid_products');
...
//        }
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = $this->productFactory->create()->getCollection()->addAttributeToSelect(
            ...
            'position',
            'pratech_banner_product',
            'position',
            'product_id=entity_id',
            'banner_id=' . (int)$this->getRequest()->getParam('id', 0),
            'left'
        )->setStore(
            $store
        );
    ...
    public function getSelectedProducts(): array
    {
        ...
        if ($bannerId) {
            $selectedProducts = [];
            $productAndPosition = $this->banner->getProductsAndPosition($bannerId);

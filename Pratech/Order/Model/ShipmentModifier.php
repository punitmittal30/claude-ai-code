...
class ShipmentModifier
{
    ...
    {
        $this->apiLogger->info("START Incrementing attribute $attributeCode for customer $customerId");
        ...
        $this->apiLogger->info("END Incrementing attribute $attributeCode for customer $customerId");
    }
}

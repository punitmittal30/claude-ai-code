define(
    [
        ...
        return Collection.extend(
            {
                defaults: {
                    template: 'Pratech_Return/return/order',
                    indexedReasons: [],
                    indexedConditions: [],
                    elemIndex: 0,
                    listens: {
                ...
                createItem: function (item, index) {
                    return utils.extend(
                        {}, {
                            ...
                            'component': 'Pratech_Return/js/return/order-item'
                        }
                    );
                },

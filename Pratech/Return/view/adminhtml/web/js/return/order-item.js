define(
    [
        ...
        return Element.extend(
            {
                defaults: {
                    template: 'Pratech_Return/return/order-item',
                    productTemplate: 'Pratech_Return/return/product',
                    stateTemplate: 'Pratech_Return/return/state',
                    editStateTemplate: 'Pratech_Return/return/edit-state',
                    viewFieldsTemplate: 'Pratech_Return/return/view-fields',
                    createFieldsTemplate: 'Pratech_Return/return/create-fields',
                    qty: 0,
                    items: []
                },
                ...
                validate: function () {
                    ...
                    _.each(
                        this.items(), function (productRow) {
                                ...
                                if (productRow.condition_id == 0 || productRow.reason_id() == 0 || productRow.condition_id == 0) {
                                    if (valid) {
                                        ...
                                        this.containers[0].validateError(
                                            $.mage.__('Reason are required field.')
                                        );
                                    }
                                } else if (valid) {

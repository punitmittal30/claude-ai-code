...
/**
 * Export promos to csv file
 */
class ExportCouponsCsv extends PromoCode implements HttpGetActionInterface, HttpPostActionInterface
{
    /**
     * Export promo codes as CSV file
     *

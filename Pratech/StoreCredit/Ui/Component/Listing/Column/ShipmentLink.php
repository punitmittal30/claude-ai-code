...
class ShipmentLink extends Column
{
     ...
     * Url path
     */
    public const URL_RELATIVE_PATH = 'sales/shipment/view';
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                if (!empty($item[$fieldName])) {
                    $link = $this->urlBuilder->getUrl(static::URL_RELATIVE_PATH, ['shipment_id' => $item[$fieldName]]);

...
class FlushWarehouseFiltersCache extends Action
{
    /**
    ...
    public function execute()
    {
        try {
            ...
            $this->messageManager->addSuccessMessage(__('The warehouse filters cache has been cleaned.'));
        } catch (Exception $e) {
            $this->messageManager->addErrorMessage(__(
                'An error occurred while cleaning the warehouse filters cache: %1',
                $e->getMessage()
            ));
        }

...
class CacheService implements CacheServiceInterface
{
    ...
    {
        $cacheKey = $this->getProductStaticAttributesCacheKey($productId);
        return $this->remove($cacheKey);
    }
    ...
    {
        return "product_static_attributes_{$productId}";
    }
    ...
    {
        $cacheKey = $this->getProductDynamicAttributesCacheKey($productId);
        return $this->remove($cacheKey);
    }
    ...
    {
        return "product_dynamic_attributes_{$productId}";
    }
    ...
    {
        return $this->clean(['dark_store_carousel_products_' . $categorySlug]);
    }
    ...
    {
        return "dark_store_carousel_products_{$categorySlug}_{$pincode}";
    }
    ...
    {
        return $this->clean(['dark_store_carousel_products']);
    }
    ...
    {
        if ($this->clean([self::CACHE_KEY_CATEGORY_ID_SLUG_MAPPING])
            && $this->remove(self::CACHE_KEY_CATEGORY_ID_SLUG_MAPPING)) {
            return true;
        }
        return false;
    }

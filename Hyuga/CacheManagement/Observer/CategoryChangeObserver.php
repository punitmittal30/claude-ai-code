...
class CategoryChangeObserver implements ObserverInterface
{
    /**
        ...
        try {
            ...
            switch ($eventName) {
                ...
                case 'catalog_category_change_products':
                    ...
                    $this->cacheService->clearCategoryIdSlugMappingCache();

                    // Clear dark store product carousel cache for all pincode by category slug.
                    $this->cacheService->clearDarkStoreCarouselProductsCache($category->getUrlKey());
                    break;
            }
        } catch (Exception $e) {
